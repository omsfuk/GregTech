...
public abstract class AbstractRecipeLogic extends MTETrait implements IWorkable {
    ...
    public <T> T getCapability(Capability<T> capability) {
        ...
        } else if (capability == GregtechTileCapabilities.CAPABILITY_ABSTRACT_RECIPE_LOGIC) {
            return GregtechTileCapabilities.CAPABILITY_ABSTRACT_RECIPE_LOGIC.cast(this);
        }
        return null;
    }
